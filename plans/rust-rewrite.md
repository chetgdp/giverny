...
The Architecture maps: Various `Backend` interface become a trait(s), NDJSON parsing becomes serde (which is fast af), process control becomes nix, HTTP server becomes axum or something else. ~5,200 lines of TS becomes ~6,000-8,000 lines of Rust. 
