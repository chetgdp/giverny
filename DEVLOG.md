...
**In Context Learning** -> **Environment Learning** -> Skill

Conversation history is a file buffer stored somewhere. The model searches it with the tools it already has. You can do db or just text. No conversation tool. No context compacting. No summarization. Files and grep.
Model
